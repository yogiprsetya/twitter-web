...
export const TweetCard = () => {
  return (
    <div className="flex items-start gap-3 p-4 border-b border-dark-7 dark:border-dark-3">
      ...
      <div className="flex flex-col grow">
        ...
        <footer className="flex items-center justify-between [&_svg]:size-4 text-dark-5 font-medium">
