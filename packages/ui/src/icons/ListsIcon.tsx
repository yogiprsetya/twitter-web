...
export const ListsIconDefault: React.FC<IconProps> = ({
  className,
  ...props
}) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M17 8.64002H7C6.586 8.64002 6.25 8.30301 6.25 7.89001C6.25 7.47701 6.586 7.14001 7 7.14001H17C17.414 7.14001 17.75 7.47501 17.75 7.89001C17.75 8.30501 17.414 8.64002 17 8.64002ZM17 12.75H7C6.586 12.75 6.25 12.414 6.25 12C6.25 11.586 6.586 11.25 7 11.25H17C17.414 11.25 17.75 11.586 17.75 12C17.75 12.414 17.414 12.75 17 12.75ZM12 16.86H7C6.586 16.86 6.25 16.525 6.25 16.11C6.25 15.695 6.586 15.36 7 15.36H12C12.414 15.36 12.75 15.697 12.75 16.11C12.75 16.523 12.414 16.86 12 16.86Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const ListsIconSelected: React.FC<IconProps> = ({
  className,
  ...props
}) => {
  return (
