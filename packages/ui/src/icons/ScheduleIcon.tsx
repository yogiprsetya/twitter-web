  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_4_210)">
        ...
        />
        <path
          d="M15.5 10.4C12.1 10.4 9.30005 13.2 9.30005 16.6C9.30005 20 12.1 22.8 15.5 22.8C18.9 22.8 21.7 20 21.7 16.6C21.7 13.2 18.9 10.4 15.5 10.4ZM15.5 21.4C12.9 21.4 10.8 19.3 10.8 16.7C10.8 14.1 12.9 12 15.5 12C18.1 12 20.2 14.1 20.2 16.7C20.2 19.2 18.1 21.4 15.5 21.4Z"
          fill="currentColor"
        />
        <path
